                    ...
                    <CCardBody>
                        <form onSubmit={handleSubmit(saveOrUpdateStudent)} className="form-horizontal">
                            ...
                            <CFormGroup row>
                                ...
                                <CCol xs="12" md="4">
                                <CLabel>Choose Priority</CLabel><br/>
                                    <label htmlFor="1" variant="custom-radio" inline="true">
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name="priority" className="form-checkbox" id="1" value="1" 
                                          />
                                        &nbsp;1
                                    </label>
                                    <label htmlFor="2" variant="custom-radio" inline="true">
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name="priority" className="form-checkbox" id="2" value="2" 
                                           />
                                        &nbsp;2
                                    </label>
                                    <label htmlFor="3" variant="custom-radio" inline="true">
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name="gender" className="form-checkbox" id="3" value="3" 
                                            />
                                        &nbsp;3
                                    </label>
                                </CCol>
